...
BuriedEngine::BuriedEngine(OSystem *syst, const BuriedGameDescription *gameDesc) : Engine(syst), _gameDescription(gameDesc) {
	...
	SearchMan.addSubDirectoryMatching(gameDataDir, "data1", 0, 3); // GOG
	SearchMan.addSubDirectoryMatching(gameDataDir, "data2", 0, 3); // GOG
	SearchMan.addSubDirectoryMatching(gameDataDir, "data3", 0, 3); // GOG
}
